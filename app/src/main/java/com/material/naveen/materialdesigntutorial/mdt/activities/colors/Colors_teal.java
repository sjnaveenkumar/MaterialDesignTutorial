 ...
 */
public class Colors_teal extends BaseActivity {

    String[] value_Accents = {"A7FFEB", "64FFDA", "1DE9B6", "00BFA5"};
    String[] value_pallets = {"E0F2F1", "B2DFDB", "80CBC4", "4DB6AC", "26A69A", "009688", "00897B", "00796B", "00695C", "004D40"};
    ...
    String value_primary = "009688";
    String value_primaryDark = "00796B";
