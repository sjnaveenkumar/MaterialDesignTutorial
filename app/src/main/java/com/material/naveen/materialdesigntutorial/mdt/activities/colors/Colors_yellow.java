 ...
 */
public class Colors_yellow extends BaseActivity {


    String[] value_Accents = {"FFFF8D", "FFFF00", "FFEA00", "FFD600"};
    String[] value_pallets = {"FFFDE7", "FFF9C4", "FFF59D", "FFF176", "FFEE58", "FFEB3B", "FDD835", "FBC02D", "F9A825", "F57F17"};
    ...
    String value_primary = "FFEB3B";
    String value_primaryDark = "FBC02D";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_primary_name.setTextColor(black_color);
        tv_primary_value.setTextColor(black_color);
        tv_primarydark_name.setTextColor(black_color);
        tv_primarydark_value.setTextColor(black_color);
        tv_accent_name_1.setTextColor(black_color);
        tv_accent_value_1.setTextColor(black_color);
        tv_accent_name_2.setTextColor(black_color);
        tv_accent_value_2.setTextColor(black_color);
        tv_accent_name_3.setTextColor(black_color);
        tv_accent_value_3.setTextColor(black_color);
        tv_accent_name_4.setTextColor(black_color);
        tv_accent_value_4.setTextColor(black_color);
        ...
        tv_color_name_400.setTextColor(black_color);
        tv_color_name_500.setTextColor(black_color);
        tv_color_name_600.setTextColor(black_color);
        tv_color_name_700.setTextColor(black_color);
        tv_color_name_800.setTextColor(black_color);
        tv_color_name_900.setTextColor(black_color);
        ...
        tv_color_value_400.setTextColor(black_color);
        tv_color_value_500.setTextColor(black_color);
        tv_color_value_600.setTextColor(black_color);
        tv_color_value_700.setTextColor(black_color);
        tv_color_value_800.setTextColor(black_color);
        tv_color_value_900.setTextColor(black_color);
