 ...
 */
public class Theme_try extends BaseActivity implements View.OnClickListener {
    ...
    public void setcolor(final int clr, final LinearLayout linearLayout) {
        LayoutInflater layoutInflater = LayoutInflater.from(Theme_try.this);
        final View cusDialogView = layoutInflater.inflate(
                R.layout.custom_alert_dialog, null);
        final AlertDialog dia = new AlertDialog.Builder(Theme_try.this).create();
        ...
        cusDialogView.findViewById(R.id.btn_alert_apply).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Toast.makeText(Theme_try.this, "Invalid Color code", Toast.LENGTH_SHORT).show();
                }
        ...
        cusDialogView.findViewById(R.id.txt_gotocolos).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Theme_try.this, Colors.class));
            }
        });
        dia.show();
