 ...
 */
public class ColorsLlime extends BaseActivity {


    String[] value_Accents = {"F4FF81", "EEFF41", "C6FF00", "AEEA00"};
    String[] value_pallets = {"F9FBE7", "F0F4C3", "E6EE9C", "DCE775", "D4E157", "CDDC39", "C0CA33", "AFB42B", "9E9D24", "827717"};
    ...
    String value_primary = "CDDC39";
    String value_primaryDark = "AFB42B";
