 ...
 */
public class Colors_purple extends BaseActivity {

    String[] value_Accents = {"EA80FC", "E040FB", "D500F9", "AA00FF"};
    String[] value_pallets = {"F3E5F5", "E1BEE7", "CE93D8", "BA68C8", "AB47BC", "9C27B0", "8E24AA", "7B1FA2", "6A1B9A", "4A148C"};
    ...
    String value_primary = "9C27B0";
    String value_primaryDark = "7B1FA2";
