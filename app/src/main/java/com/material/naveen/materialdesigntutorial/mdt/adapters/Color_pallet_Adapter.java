 ...
 */
public class Color_pallet_Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public Color_pallet_Adapter(Context contex, String[] value_Accents, String[] value_Pallets, String[] name_Accents, String[] name_pallets,
