 ...
 */
public class Center_aligned_Fragment extends Fragment {


    TextView tv_init, tv_init_java, tv_red;
    ImageView img_tab;

    public Center_aligned_Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        intit(v);
        tv_red.setText("tab.xml (app:tabgravity:\"center\")");
    ...
    public void intit(View v) {
        ...
        img_tab.setImageResource(R.drawable.center_tab);
